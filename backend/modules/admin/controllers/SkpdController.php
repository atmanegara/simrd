...
class SkpdController extends Controller{
    ...
    public function actionGetDetailPemohon($nokartu)
    {
        
        $sql = "select B.id as id_detail_pemohon,A.nama, A.alamat, A.nik_npwp, C.jenis, C.keterangan, B.lokasi, B.waktu_mulai, B.waktu_akhir,"
                . "D.ukuran1, D.ukuran2, D.satuan1, D.satuan2, B.banyak, D.sisi "
                . "from tbl_detail_pemohon B "
                . "left join tbl_pemohon A on B.id_pemohon=A.id "
                . "left join tbl_jenis_reklame C on B.id_reklame=C.id "
                . "left join dtl_pemohon_reklame D on B.nokartu=D.nokartu "
                . "where B.nokartu=:nokartu";
        $param = [
            ':nokartu'=>$nokartu,
        ];
